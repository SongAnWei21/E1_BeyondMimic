...
# Import extensions to set up environment tasks(关键)
import e1_lab.tasks  # 会去执行你项目 e1_lab/tasks/ 目录下的 __init__.py 文件，然后注册机器人

#from e1_lab.utils.my_on_policy_runner import MotionOnPolicyRunner as OnPolicyRunner
from rsl_rl.runners import OnPolicyRunner
from action_delay import ActionDelayWrapper # 加入动作延迟包装器
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    if args_cli.log_dir_path:
        log_dir = args_cli.log_dir_path
    else:
    ...
    # 引入动作延迟，一个delay_steps等于20ms(50Hz)
