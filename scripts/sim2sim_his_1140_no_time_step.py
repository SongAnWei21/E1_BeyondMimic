"""Unified sim2sim script for E1 robot (10-frame Term-wise History, 1140 obs, 硬编码参数版)."""
...
ROBOT_CONFIG = {
    "num_actions": 21,
    "num_obs": 1140,  # 1140维 (包含 6D ref_ori)
...
def run_simulation(motion_file: str, xml_path: str, policy_path: str):
    config = ROBOT_CONFIG
    print(f"[INFO]: E1 (1140 obs, 完美初态降落防炸机版, 硬编码参数无TimeStep)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy_path", type=str, default="policy/his_1140/model_50k_action.onnx")
