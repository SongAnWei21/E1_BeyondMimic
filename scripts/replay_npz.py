...
parser.add_argument("--robot", type=str, choices=["hi", "pi_plus","n1","e1","x1_23dof"], required=True,
...
# Pre-defined configs
##
from whole_body_tracking.robots.x1_23dof import X1_23DOF_CFG
from whole_body_tracking.robots.n1 import N1_CFG
from whole_body_tracking.robots.e1 import E1_CFG
