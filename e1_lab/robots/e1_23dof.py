...
E1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{ASSET_DIR}/e1/urdf/E1_23dof.urdf", 
    ...
    actuators={
        ...
        "arms": ImplicitActuatorCfg(
            ...
            effort_limit_sim={
                ...
                ".*_wrist_roll_joint": EFFORT_LIMIT_RS00,
            ...
            velocity_limit_sim={
                ...
                ".*_wrist_roll_joint": VELOCITY_LIMIT_RS00,
            ...
            stiffness={
                ...
                ".*_elbow_joint": STIFFNESS_RS06,
                ".*_wrist_roll_joint": STIFFNESS_RS00,
            ...
            damping={
                ...
                ".*_elbow_joint": DAMPING_RS06,
                ".*_wrist_roll_joint": DAMPING_RS00,
            ...
            armature={
                ...
                ".*_wrist_roll_joint": ARMATURE_RS00,
...
E1_ACTION_SCALE = {}
for a in E1_CFG.actuators.values():
    ...
    for n in names:
        if n in e and n in s and s[n]:
            E1_ACTION_SCALE[n] = 0.25 * e[n] / s[n]
